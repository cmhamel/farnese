...
//       Node::MainFunction { .. } => write!(f, "Main func"),
...
//       Node::StructField { name, field_type } => write!(f, "{} {}", name, field_type),
//       Node::StructType { name, generics, supertype, fields } => write!(f, "{} {:?} <: {} {:?}", name, generics, supertype, fields),
